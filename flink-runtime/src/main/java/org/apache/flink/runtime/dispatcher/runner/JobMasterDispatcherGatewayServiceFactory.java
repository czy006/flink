...
class JobMasterDispatcherGatewayServiceFactory
    ...
    JobMasterDispatcherGatewayServiceFactory(
    ...
    public AbstractDispatcherLeaderProcess.DispatcherGatewayService create(
        ...
        final JobMasterDispatcher jobMasterDispatcher;
        try {
            jobMasterDispatcher =
                    dispatcherFactory.createJobMasterDispatcher(
                            rpcService,
                            fencingToken,
                            recoveredJobs,
        ...
        jobMasterDispatcher.start();

        return JobMasterDispatcherGatewayService.from(jobMasterDispatcher);
    }
}
